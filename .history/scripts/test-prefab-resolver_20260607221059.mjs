...
// safeParseJson lives elsewhere in worker/index.js; inline a shim for the test.
const shim = `function safeParseJson(s, f){ if(s==null) return f; try{ return JSON.parse(s); }catch{ return f; } }\n`;
const factory = new Function(
  shim + block + "return { resolveEquipment, resolveAnimationPack, BONE_CONTAINERS };",
);
